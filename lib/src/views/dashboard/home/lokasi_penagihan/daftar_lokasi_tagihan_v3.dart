          ...
          children: [
                              ...
                              ? Container(
                                ...
                                child: DataTable(
                                    ...
                                    rows: List<DataRow>.generate(trackingController.listRuteTerbaru.value!.data!.length, (i){
                                      return DataRow(
                                        color: WidgetStatePropertyAll<Color?>(trackingController.listRuteTerbaru.value?.data?[i].status == "5" ?  Colors.yellow.shade200 : trackingController.listRuteTerbaru.value?.data?[i].status == "3" ? Colors.blue.shade100 : trackingController.listRuteTerbaru.value?.data?[i].status == "4" ? Colors.green.shade100 : Colors.white),
                                        cells: <DataCell>[
                                          // Kode
                                          DataCell(
                                            placeholder: true,
            ...
            //Loading
              Positioned(
                ...
                bottom: 0,
                left: 0,
                child: Obx(() => trackingController.isLoading.value ? 
                  Container(
                    width: size.width,
                    height: size.height,
