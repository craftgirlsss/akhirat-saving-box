...
class AirplaneServices extends StatefulWidget {
  const AirplaneServices({super.key});

  @override
  State<AirplaneServices> createState() => _AirplaneServicesState();
}

class _AirplaneServicesState extends State<AirplaneServices> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Pilih Perusahaan Pesawat", style: textStyle.defaultTextStyleBold(fontSize: 16)),
      ),
      body: Container(
          ...
          child: Column(
            children: [
              ...
              GridView.count(
                ...
                children:[
                  cardItem(urlImage: '$urlAssetImage/lion.png', priceOff: null, title: "Lion Air"),
                  cardItem(urlImage: '$urlAssetImage/merpati.jpeg', priceOff: null, title: "Merpati Air"),
                  cardItem(urlImage: '$urlAssetImage/pelita.jpg', priceOff: null, title: "Pelita Air"),
                  cardItem(urlImage: '$urlAssetImage/airasia.png', priceOff: null, title: "Air Asia"),
                ]
              ),
            ],
          ),
