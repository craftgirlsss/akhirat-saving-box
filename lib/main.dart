...
import 'package:asb_app/sources/views/dashboards/donautur/donatur_detail_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(
          name: '/dashboard/donatur-list',
          page: () => DonaturListView(),
        ),
        GetPage(
          name: '/dashboard/donatur-list/donatur-detail',
          page: () => DonaturDetailView(),
        ),
        GetPage(
          name: '/dashboard/donatur-list/donatur-detail/perolehan',
          page: () => PerhitunganPerolehanView(),
        ),
      ],
    );
  }
