...
class TrainListBrand extends StatefulWidget {
  const TrainListBrand({super.key});

  @override
  State<TrainListBrand> createState() => _TrainListBrandState();
}

class _TrainListBrandState extends State<TrainListBrand> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Pilih Perusahaan Kereta Logistik", style: textStyle.defaultTextStyleBold(fontSize: 16)),
        ),
        body: Container(
              ...
              children: [
                ...
                GridView.count(
                  shrinkWrap: true,
                    ...
                    children:[
                      cardItem(urlImage: '$urlAssetImage/acc.jpg', priceOff: null, title: "ACC Express"),
                      cardItem(urlImage: '$urlAssetImage/adipuralog.png', priceOff: null, title: "Adipura Logistic"),]
                ),
              ],
            ),
          ),
