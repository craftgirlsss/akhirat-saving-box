...
class ShipListServices extends StatefulWidget {
  const ShipListServices({super.key});

  @override
  State<ShipListServices> createState() => _ShipListServicesState();
}

class _ShipListServicesState extends State<ShipListServices> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Pilih Perusahaan Kapal", style: textStyle.defaultTextStyleBold(fontSize: 16)),
        ),
        body: Container(
              ...
              children: [
                ...
                GridView.count(
                  shrinkWrap: true,
                    ...
                    children:[
                      cardItem(urlImage: '$urlAssetImage/spil.png', priceOff: null, title: "SPIL"),
                      cardItem(urlImage: '$urlAssetImage/oocl.jpg', priceOff: null, title: "OOCL"),
                      cardItem(urlImage: '$urlAssetImage/maersk.jpg', priceOff: null, title: "MAERSK"),
                      cardItem(urlImage: '$urlAssetImage/msc.jpg', priceOff: null, title: "MSC"),
                    ]
                ),
              ],
            ),
