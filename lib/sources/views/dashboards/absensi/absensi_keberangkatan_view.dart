import 'dart:io';
import 'package:asb_app/sources/controllers/absensi_keberangkatan_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class AbsensiKeberangkatanView extends StatelessWidget {
  final AbsensiKeberangkatanController controller = Get.put(AbsensiKeberangkatanController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Absen Keberangkatan', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Ambil Dokumentasi Keberangkatan', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ...
            const Text('Catatan Keberangkatan', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ...
            Obx(() => SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('Kirim Absensi', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
